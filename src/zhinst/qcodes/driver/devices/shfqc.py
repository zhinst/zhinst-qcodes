...
from zhinst.toolkit.driver.devices.shfqc import SHFQC as TKSHFQC
...
class AWGCore(ZINode):
    ...
    def configure_marker_and_trigger(
        ...
        """
        self._tk_object.configure_marker_and_trigger(
    ...
    def configure_channel(
        ...
        Args:
            ...
            rf_path: Flag if the RF(True) or LF(False) path should be
                configured.
        """
        self._tk_object.configure_channel(
            enable=enable,
        ...
        *,
        ...
        Args:
            ...
            sine_generator_index: Selects which sine generator to use on a
                given channel.
        """
        self._tk_object.configure_pulse_modulation(
            enable=enable,
            osc_index=osc_index,
        ...
        *,
        ...
        Args:
            ...
            sine_generator_index: Selects which sine generator to use on a given
                channel
        """
        self._tk_object.configure_sine_generation(
            enable=enable,
            osc_index=osc_index,
            osc_frequency=osc_frequency,
            phase=phase,
...
class Generator(ZINode):
    ...
    def write_to_waveform_memory(
        ...
        """
        self._tk_object.write_to_waveform_memory(
            pulses=pulses, clear_existing=clear_existing
        )

    def read_from_waveform_memory(self, slots: Optional[list[int]] = None) -> Waveforms:
    ...
    def configure_sequencer_triggering(
        ...
        """
        self._tk_object.configure_sequencer_triggering(
...
class Qudit(ZINode):
    ...
    def configure(self, qudit_settings: QuditSettings, enable: bool = True) -> None:
        ...
        """
        self._tk_object.configure(qudit_settings=qudit_settings, enable=enable)
...
class Readout(ZINode):
    ...
    def configure_result_logger(
        ...
        *,
        ...
        """
        self._tk_object.configure_result_logger(
    ...
    def stop(self, *, timeout: float = 10, sleep_time: float = 0.05) -> None:
        ...
        Raises:
            TimeoutError: The result logger could not been stopped within the
                given time.
        """
        self._tk_object.stop(timeout=timeout, sleep_time=sleep_time)
    ...
    def read(self, *, timeout: float = 10) -> np.ndarray:
        ...
        *,
        ...
        Args:
            ...
            clear_existing: Flag whether to clear the waveform memory before
                the present upload.
        """
        self._tk_object.write_integration_weights(
            weights=weights,
    ...
    def read_integration_weights(self, slots: Optional[list[int]] = None) -> Waveforms:
    ...
    def run(
        ...
        Raises:
            TimeoutError: The scope did not start within the specified
                timeout.
        """
        self._tk_object.run(single=single, timeout=timeout, sleep_time=sleep_time)
...
class SHFQC(ZIBaseInstrument):
    ...
    def start_continuous_sw_trigger(
        ...
        """
        self._tk_object.start_continuous_sw_trigger(
