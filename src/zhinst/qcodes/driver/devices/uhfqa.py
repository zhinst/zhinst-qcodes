...
from zhinst.toolkit.driver.devices.uhfqa import UHFQA as TKUHFQA
...
class Integration(ZINode):
    ...
    def write_integration_weights(self, weights: Union[Waveforms, dict]) -> None:
        ...
        """
        self._tk_object.write_integration_weights(weights=weights)
...
class QAS(ZINode):
    ...
    def adjusted_delay(self, value: Optional[int] = None) -> int:
...
class UHFQA(ZIBaseInstrument):
    ...
    def enable_qccs_mode(self) -> None:
        ...
        """
        self._tk_object.enable_qccs_mode()
